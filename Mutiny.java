...
public class Mutiny {
    ...
    public static void main(String... args) {
        ...
        System.out.println();
        System.out.println();
        System.out.println("Exercise 1: hello Mutiny!");

        //Exercise 1: hello Mutiny!
        helloMutiny();

        System.out.println();
        System.out.println("Exercise 2: Mutiny uses a builder API");

        //Exercise 2: Mutiny uses a builder API
        builderAPI();

        System.out.println();
        System.out.println("Excercise 3: The Uni type");

        //Excercise 3: The Uni type
        uniType();

        System.out.println();
        System.out.println("Excercise 4: Subscribing to an Uni");

        //Excercise 4: Subscribing to an Uni
        subscribingUni();

        System.out.println();
        System.out.println("Excercise 5: Supplying an Uni");

        //Excercise 5: Supplying an Uni
        supplyingUni();

        System.out.println();
        System.out.println("Excercise 6: Failing Unis");

        //Excercise 6: Failing Unis
        failingUnis();

        System.out.println();
        System.out.println("Excercise 7: Operation to not produce a result");

        //Excercise 7: Operation to not produce a result
        voidUni();

        System.out.println();
        System.out.println("Excercise 8: The Multy type");

        //Excercise 8: The Multy type
        multiType();

        System.out.println();
        System.out.println("Excercise 9: Supplying a Multi");

        //Excercise 9: Supplying a Multi
        supplyingMulti();

        System.out.println();
        System.out.println("Excercise 10: Empty Multis");

        //Excercise 10: Empty Multis
        emptyMulti();

        System.out.println();
        System.out.println("Excercise 11: Managing null");

        //Excercise 11: Managing null
        uniNull();

        System.out.println();
        System.out.println("Excercise 12: From multi to uni of list");

        //Excercise 12: From multi to uni of list
        multiToUniOfList();

        System.out.println();
        System.out.println("Excercise 13: Recovering from fail");

        //Excercise 13: Recovering from fail
        recoveringFromFail();

        System.out.println();
        System.out.println("Excercise 14: Chain an uni with another one");

        //Excercise 14: Chain an uni with another one
        chainUnis();

        System.out.println();
        System.out.println("Excercise 15: Combine several unis (paralelly)");

        //Excercise 15: Combine several unis (paralelly)
        combineUnis();

        System.out.println();
        System.out.println("Excercise 16: Combine several unis (paralelly) with a failure");
